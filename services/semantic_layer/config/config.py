...
class SemanticLayerConfig:
    ...
    TRANSPORT: str = os.getenv('SEMANTIC_LAYER_TRANSPORT', 'streamable-http')
    
    # Logging
    LOG_LEVEL: str = os.getenv('LOG_LEVEL', 'INFO')
    
    # Agent Cards
    AGENT_CARDS_BASE: str = os.getenv('AGENT_CARDS_BASE', '/app/agent_cards')

    # Tool Cards
    TOOL_CARDS_BASE: str = os.getenv('TOOL_CARDS_BASE', '/app/tool_cards')
    ...
    # Security
    GUARDIAN_URL: str = os.getenv('GUARDIAN_URL', 'http://abi-swarm-guardian:8100')
    OPA_URL: str = os.getenv('OPA_URL', 'http://abi-swarm-guardian:8181')
    
    # Cache Configuration
    VALIDATION_CACHE_TTL: int = int(os.getenv('VALIDATION_CACHE_TTL', '300'))  # 5 minutes
    
    # Weaviate Configuration
    WEAVIATE_HOST: str = os.getenv('WEAVIATE_HOST', 'http://abi-swarm-weaviate:8080')
    ...
    OLLAMA_HOST: str = os.getenv('OLLAMA_HOST', 'http://abi-swarm-ollama:11434')
